var sketchProc = function(processingInstance) {
    ...
    mouseDragged = function(){
        ...
        var t = ["Happs Conner, thanks for being such a good friend.\nCant wait to go to hs with you,\nhope we have some of the same classes\n-Ava", "Happy Birthday Connor!\nHope you have a very\ngood birthday and a very good day\n-Cohen", "Hey Connor.. happy birthday!\nIf I were to give you one piece of advice,\nit's to not sneeze around me..\nI WILL make jokes about you dying\n-Millie", "Happs Connor, haven't known you for long,\nbut ur a really good friend, have a good day\n-Christian"];
        ...
        for (var i = 100; i <= 1100; i+= 300){
            ...
            for (var i = 100; i <= 1100; i+= 300){
                pushMatrix();
                translate(i + 100,(i - 100)/300 % 2 === 0 ? 150: 450);
                if (dist(mouseX, mouseY, i + 100,(i - 100)/300 % 2 === 0 ? 150: 450) < 70){
                    scale(2);
                }
                textFont(createFont('calibri'), 7);
                fill(255);
                rect(-80, -30, 160, 60);
                fill(0);
                text(t[(i - 100)/300], 0, 0);
                popMatrix();
            }
            pushMatrix();
                ...
                fill(frameCount % 255, frameCount % 50, frameCount % 150);
